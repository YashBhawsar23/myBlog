...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-gradient-to-b from-white to-indigo-50">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <a
            href="#"
          ...
          <p className="mt-4 text-sm text-gray-600 lg:max-w-sm">
            Discover stories, thinking, and expertise from writers on any topic.
          </p>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-indigo-600 font-bold">
              Categories
            </h3>
          ...
          <div className="space-y-3">
            <h3 className="uppercase text-indigo-600 font-bold">Join Us</h3>
            <ul className="space-y-1 text-gray-600">
              <li>
                <a href="#" className="hover:text-indigo-600">
                  Write for us
          ...
          <div className="space-y-3">
            <div className="uppercase text-indigo-600 font-bold">Follow us</div>
            <div className="flex justify-start space-x-3">
              <a
                href="#"
                title="Facebook"
